    ...
    jobTargetRef: {
      ...
      template: {
        ...
        spec: {
          ...
          '#schedulingGates':: d.obj(help='"SchedulingGates is an opaque list of values that if specified will block scheduling the pod. More info:  https://git.k8s.io/enhancements/keps/sig-scheduling/3521-pod-scheduling-readiness. \\n This is an alpha-level feature enabled by PodSchedulingReadiness feature gate."'),
          schedulingGates: {
          ...
          '#withSchedulingGates':: d.fn(help='"SchedulingGates is an opaque list of values that if specified will block scheduling the pod. More info:  https://git.k8s.io/enhancements/keps/sig-scheduling/3521-pod-scheduling-readiness. \\n This is an alpha-level feature enabled by PodSchedulingReadiness feature gate."', args=[d.arg(name='schedulingGates', type=d.T.array)]),
          ...
          '#withSchedulingGatesMixin':: d.fn(help='"SchedulingGates is an opaque list of values that if specified will block scheduling the pod. More info:  https://git.k8s.io/enhancements/keps/sig-scheduling/3521-pod-scheduling-readiness. \\n This is an alpha-level feature enabled by PodSchedulingReadiness feature gate."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='schedulingGates', type=d.T.array)]),
