{
  ...
  spec: {
        ...
        spec: {
          ...
          containers: {
            ...
            lifecycle: {
              ...
              postStart: {
                '#exec':: d.obj(help='"One and only one of the following should be specified. Exec specifies the action to take."'),
                exec: {
                ...
                '#tcpSocket':: d.obj(help='"TCPSocket specifies an action involving a TCP port. TCP hooks not yet supported TODO: implement a realistic TCP lifecycle hook"'),
                tcpSocket: {
          ...
          securityContext: {
            ...
            '#sysctls':: d.obj(help='"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch."'),
            sysctls: {
    ...
    triggers: {
      ...
      '#withFallback':: d.fn(help='', args=[d.arg(name='fallback', type=d.T.integer)]),
