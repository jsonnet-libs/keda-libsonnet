{
  ...
  spec: {
    ...
    '#boundServiceAccountToken':: d.obj(help=''),
    ...
    hashiCorpVault: {
      ...
      credential: {
        ...
        '#withServiceAccountName':: d.fn(help='', args=[d.arg(name='serviceAccountName', type=d.T.string)]),
        withServiceAccountName(serviceAccountName): { spec+: { hashiCorpVault+: { credential+: { serviceAccountName: serviceAccountName } } } },
    ...
    '#withBoundServiceAccountToken':: d.fn(help='', args=[d.arg(name='boundServiceAccountToken', type=d.T.array)]),
    withBoundServiceAccountToken(boundServiceAccountToken): { spec+: { boundServiceAccountToken: if std.isArray(v=boundServiceAccountToken) then boundServiceAccountToken else [boundServiceAccountToken] } },
    '#withBoundServiceAccountTokenMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='boundServiceAccountToken', type=d.T.array)]),
    withBoundServiceAccountTokenMixin(boundServiceAccountToken): { spec+: { boundServiceAccountToken+: if std.isArray(v=boundServiceAccountToken) then boundServiceAccountToken else [boundServiceAccountToken] } },
