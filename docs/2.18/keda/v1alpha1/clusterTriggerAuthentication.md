---
permalink: /2.18/keda/v1alpha1/clusterTriggerAuthentication/
---
...
* [`obj spec`](#obj-spec)
  * [`fn withBoundServiceAccountToken(boundServiceAccountToken)`](#fn-specwithboundserviceaccounttoken)
  * [`fn withBoundServiceAccountTokenMixin(boundServiceAccountToken)`](#fn-specwithboundserviceaccounttokenmixin)
  ...
  * [`obj spec.awsSecretManager`](#obj-specawssecretmanager)
    ...
    * [`obj spec.awsSecretManager.secrets`](#obj-specawssecretmanagersecrets)
      ...
      * [`fn withSecretKey(secretKey)`](#fn-specawssecretmanagersecretswithsecretkey)
  ...
  * [`obj spec.boundServiceAccountToken`](#obj-specboundserviceaccounttoken)
    * [`fn withParameter(parameter)`](#fn-specboundserviceaccounttokenwithparameter)
    * [`fn withServiceAccountName(serviceAccountName)`](#fn-specboundserviceaccounttokenwithserviceaccountname)
  ...
  * [`obj spec.hashiCorpVault`](#obj-spechashicorpvault)
    ...
    * [`obj spec.hashiCorpVault.credential`](#obj-spechashicorpvaultcredential)
      ...
      * [`fn withServiceAccountName(serviceAccountName)`](#fn-spechashicorpvaultcredentialwithserviceaccountname)
...
### fn spec.withBoundServiceAccountToken

```ts
withBoundServiceAccountToken(boundServiceAccountToken)
```



### fn spec.withBoundServiceAccountTokenMixin

```ts
withBoundServiceAccountTokenMixin(boundServiceAccountToken)
```
...
### fn spec.awsSecretManager.secrets.withSecretKey
...
## obj spec.boundServiceAccountToken



### fn spec.boundServiceAccountToken.withParameter
...
### fn spec.boundServiceAccountToken.withServiceAccountName
...
### fn spec.hashiCorpVault.credential.withServiceAccountName
